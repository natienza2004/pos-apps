...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .brand { height: 76px; display: flex; align-items: center; gap: 10px; padding: 0 18px; font-weight: 800; font-size: 16px; border-bottom: 1px solid var(--line); }
        ...
        .topbar { position: fixed; left: 238px; right: 0; top: 0; height: 76px; display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 0 24px; background: #fff; border-bottom: 1px solid var(--line); z-index: 15; }
    ...
    <div class="app">
        <aside class="sidebar">
            ...
            <nav class="nav">
                ...
                <a href="#"><i data-lucide="users"></i>User Management</a>
        ...
        <header class="topbar">
            ...
            <div class="search-wrap"><i data-lucide="search"></i><input class="search" placeholder="Search products, records..."></div>
            <div class="user">
                <i data-lucide="bell"></i>
                <span style="height:32px;border-left:1px solid var(--line)"></span>
                <div style="text-align:right"><strong>Natienza Admin</strong><br><span class="muted">Admin</span></div>
